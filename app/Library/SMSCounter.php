<?php
    ...
    class SMSCounter
    {
         ...
         */
        public function count($text, $type = self::GSM_7BIT): stdClass
        {
         ...
         * @return stdClass Object with params encoding,length, per_message, remaining, messages
         */
        private function doCount($text, $supportShiftTables, $type = self::GSM_7BIT): stdClass
        {
            ...
            if ($type === self::WHATSAPP) {
                $encoding = self::WHATSAPP;
            }
