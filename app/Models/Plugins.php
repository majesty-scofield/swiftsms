...
class Plugins extends Model
{
    ...
    public static function validateMetaData($config = []): void
    {
        ...
        //     throw new \Exception("The uploaded plugin requires a valid license of Swift sms to proceed");
        // }

        // // Check license type
        // if (Setting::get('license_type') != 'extended') {
        //     throw new \Exception("The uploaded plugin requires an 'Extended' license of swift sms to proceed, your current license is 'Regular'");
        // }
    }
    ...
    public static function init($plugin): void
    {
        ...
        // Register the plugin with swift sms (add a record to plugins DB table)
