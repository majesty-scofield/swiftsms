/*=========================================================================================
	...
	Description: tour
	----------------------------------------------------------------------------------------
	Item Name: Swift SMS - Bulk SMS Application For Marketing
	Author: Swift SMS
...
$(document).ready(function () {
    ...
    // tour steps
    tour.addStep('step-1', {
        text: 'Thank you for choosing Swift SMS!<br><br>' +
            'This small tour will guide you through some of the Swift SMS  features and will help you get started using the application.<br><br>' +
            'If you ever need support, please send email to <code>sales@swiftsmsgh.com</code><br><br>' +
            'Let\'s get started!',
        buttons: [
    ...
    tour.addStep('step-2', {
        text: 'In order to make things easier to manage, Swift SMS is divided into several small sub-apps, like the <code>backend, customer, api</code><br><br>' +
            ...
            'To run Swift sms, first, you need to create a <code>Sending Server</code>, then a <code>Plan</code>, after that, assign your created sending server on the plan. Finally, create a <code>customer</code> and assign the created plan.<br><br>' +
    ...
    tour.addStep('step-7', {
        text: 'Swift SMS is flexible and modern. Please check all features perfectly then you will find all details about swift sms.',
        buttons: [
            {
                text: "previous",
                action: tour.back
