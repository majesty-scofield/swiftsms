                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if( $server['settings'] != 'Twilio' && $server['settings'] != 'Zang' && $server['settings'] != 'Plivo' && $server['settings'] != 'PlivoPowerpack' && $server['settings'] != 'AmazonSNS' && $server['settings'] != 'TwilioCopilot' && $server['settings'] != SendingServer::TYPE_ULTRAMSG && $server['settings'] != SendingServer::TYPE_CLICKSEND)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MSG91 || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT || $server['settings'] == SendingServer::TYPE_SMSURWAY || $server['settings'] == SendingServer::TYPE_SMARTSMSSOLUTIONS)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    @if($server['settings'] == SendingServer::TYPE_SMSURWAY)
                                                        <label class="form-label required" for="otp_api_link">API Link</label>
                                                    @else
                                        ...
                                        @if($server['settings'] == 'SmsGatewayMe' || $server['settings'] == 'Whatsender' || $server['settings'] == 'SemySMS' || $server['settings'] == SendingServer::TYPE_TEXTBEE)
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap col-12">
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'Plivo' || $server['settings'] == 'Vonage' || $server['settings'] == 'Infobip' || $server['settings'] == SendingServer::TYPE_BULKSMSPROVIDERNG || $server['settings'] == 'Telnyx' || $server['settings'] == SendingServer::TYPE_AIRTELINDIA || $server['settings'] == SendingServer::TYPE_AUDIENCEONE || $server['settings'] == SendingServer::TYPE_ALDEAMO || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT || $server['settings'] == SendingServer::TYPE_SMARTSMSSOLUTIONS)
