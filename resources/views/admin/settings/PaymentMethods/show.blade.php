                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @elseif($gateway->type == PaymentMethods::TYPE_MYFATOORAH)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="country_iso_code" class="form-label required">Country ISO Code</label>
                                                    <input type="text" id="country_iso_code" name="country_iso_code"
                                                           class="form-control"
                                                           value="{{ $gateway->getOption('country_iso_code') }}" required>
                                                    @error('country_iso_code')
                                                    <div class="text-danger">
                                                        {{ $message }}
                                                    </div>
                                                    @enderror
                                                    <p><small class="text-primary">Accepted value: KWT, SAU, ARE, QAT, BHR, OMN, JOD, or EGY.</small></p>
                                                </div>
                                            </div>
