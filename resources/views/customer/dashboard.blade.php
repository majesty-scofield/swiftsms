                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            @can('sms_campaign_builder')
                                <div class="col-lg-3 col-sm-6 col-6 pb-1">
                                    <a href="{{ route('customer.sms.campaign_builder') }}"
                                       class="btn btn-sm btn-success w-100 text-nowrap"><i
                            ...
                            @can('view_contact_group')
                                <div class="col-lg-3 col-sm-6 col-6 pb-1">
                                    <a href="{{ route('customer.sms.import') }}" class="btn btn-sm btn-primary w-100 text-nowrap"><i
                                                data-feather="user"></i> {{__('locale.menu.Contacts')}}</a>
                                </div>
                            @endcan
