<?php
    ...
    return [
        ...
        */
        ...
        'keyword'       => env('APP_KEYWORD', 'swift sms, swiftsms, bulk sms, sms, sms marketing, laravel, framework'),
        ...
        */
        ...
        | services the application utilizes. Set this in your ".env.remove" file.
        |
        */
